...
**squad_version:** `typing.Optional[str]` 
...
**purpose:** `typing.Optional[ListFilesRequestPurpose]` — Only return files with this purpose. When omitted, files of every purpose except composer attachments are returned.
...
**assistant:** `typing.Optional[CreateAssistantDto]` — Complete assistant replacement. Omitted credentials and redacted server secrets are preserved when their endpoint URL is unchanged. Send credentials: [] to clear credentials; omit a server container to remove it.
...
**target_overrides:** `typing.Optional[AssistantOverrides]` — Complete override replacement. Omitted credentials and redacted server secrets are preserved when their endpoint URL is unchanged. Send credentials: [] to clear credentials; omit a server container to remove it.
...
**search:** `typing.Optional[str]` — Literal, case-insensitive search across eval and assistant names.
