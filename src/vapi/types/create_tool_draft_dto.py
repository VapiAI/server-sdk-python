...
from .create_tool_draft_dto_messages_item import CreateToolDraftDtoMessagesItem
...
class CreateToolDraftDto(UncheckedBaseModel):
    messages: typing.Optional[typing.List[CreateToolDraftDtoMessagesItem]] = pydantic.Field(default=None)
    """
    Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
    """

    type: typing.Optional[CreateToolDraftDtoType] = pydantic.Field(default=None)
    """
    ...
    method: typing.Optional[CreateToolDraftDtoMethod] = pydantic.Field(default=None)
    """
    ...
    verb: typing.Optional[CreateToolDraftDtoVerb] = pydantic.Field(default=None)
    """
...
update_forward_refs(CreateToolDraftDto, JsonSchema=JsonSchema)
