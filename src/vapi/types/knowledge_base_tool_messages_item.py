...
class KnowledgeBaseToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class KnowledgeBaseToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class KnowledgeBaseToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class KnowledgeBaseToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
KnowledgeBaseToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
