...
from .simulation_run_list_item_simulations_item import SimulationRunListItemSimulationsItem
from .simulation_run_list_item_status import SimulationRunListItemStatus
from .simulation_run_list_item_target import SimulationRunListItemTarget
...
class SimulationRunListItem(UncheckedBaseModel):
    ...
    status: SimulationRunListItemStatus = pydantic.Field()
    """
    ...
    simulations: typing.List[SimulationRunListItemSimulationsItem] = pydantic.Field()
    """
    Array of simulations and/or suites to run
    """

    target: SimulationRunListItemTarget = pydantic.Field()
    """
...
update_forward_refs(SimulationRunListItem)
