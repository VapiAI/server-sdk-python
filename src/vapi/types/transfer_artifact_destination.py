...
class TransferArtifactDestination_Number(UncheckedBaseModel):
    """
...
class TransferArtifactDestination_Sip(UncheckedBaseModel):
    """
    The transfer destination (phone number or SIP URI).
    """
...
TransferArtifactDestination = typing_extensions.Annotated[
    typing.Union[TransferArtifactDestination_Number, TransferArtifactDestination_Sip],
