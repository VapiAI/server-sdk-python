...
class UpdateAssistantDraftDtoCredentialsItem_11Labs(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Anthropic(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_AnthropicBedrock(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Anyscale(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_AssemblyAi(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_AzureOpenai(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Azure(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_ByoSipTrunk(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Cartesia(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Cerebras(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Cloudflare(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_CustomLlm(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Deepgram(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Deepinfra(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_DeepSeek(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Gcp(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Gladia(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Gohighlevel(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Google(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Groq(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_InflectionAi(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Langfuse(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Lmnt(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Make(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Openai(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Openrouter(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_PerplexityAi(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Playht(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_RimeAi(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Runpod(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_S3(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_S3Compatible(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Supabase(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_SmallestAi(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Tavus(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_TogetherAi(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Twilio(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Vonage(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Webhook(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_CustomCredential(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Xai(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Microsoft(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Neuphonic(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Hume(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Mistral(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Speechmatics(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Soniox(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_GoogleCalendarOauth2Client(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_GoogleCalendarOauth2Authorization(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_GoogleSheetsOauth2Authorization(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_SlackOauth2Authorization(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_GhlOauth2Authorization(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Inworld(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Minimax(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Wellsaid(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_Email(UncheckedBaseModel):
...
class UpdateAssistantDraftDtoCredentialsItem_SlackWebhook(UncheckedBaseModel):
...
UpdateAssistantDraftDtoCredentialsItem = typing_extensions.Annotated[
    typing.Union[
