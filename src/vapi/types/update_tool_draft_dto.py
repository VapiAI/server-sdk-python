...
from .update_tool_draft_dto_messages_item import UpdateToolDraftDtoMessagesItem
...
class UpdateToolDraftDto(UncheckedBaseModel):
    messages: typing.Optional[typing.List[UpdateToolDraftDtoMessagesItem]] = pydantic.Field(default=None)
    """
    Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
    """

    type: typing.Optional[UpdateToolDraftDtoType] = pydantic.Field(default=None)
    """
    ...
    method: typing.Optional[UpdateToolDraftDtoMethod] = pydantic.Field(default=None)
    """
    ...
    verb: typing.Optional[UpdateToolDraftDtoVerb] = pydantic.Field(default=None)
    """
...
update_forward_refs(UpdateToolDraftDto, JsonSchema=JsonSchema)
