...
from .knowledge_base_tool_messages_item import KnowledgeBaseToolMessagesItem
from .tool_rejection_plan import ToolRejectionPlan


class KnowledgeBaseTool(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[KnowledgeBaseToolMessagesItem]] = pydantic.Field(default=None)
    """
...
update_forward_refs(KnowledgeBaseTool)
