...
class SquadVersion(UncheckedBaseModel):
    version_name: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="versionName"),
        pydantic.Field(
            alias="versionName",
            description="Optional human-readable label for this version. Set when the version is published.",
        ),
    ] = None
    version_description: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="Optional description for this version. Set when the version is published.",
        ),
    ] = None
    ...
    squad_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="squadId",
            description="This is the unique identifier for the squad this version was snapshotted from.",
        ),
    ]
