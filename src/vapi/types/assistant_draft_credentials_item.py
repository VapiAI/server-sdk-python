...
class AssistantDraftCredentialsItem_11Labs(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Anthropic(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_AnthropicBedrock(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Anyscale(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_AssemblyAi(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_AzureOpenai(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Azure(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_ByoSipTrunk(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Cartesia(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Cerebras(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Cloudflare(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_CustomLlm(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Deepgram(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Deepinfra(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_DeepSeek(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Gcp(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Gladia(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Gohighlevel(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Google(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Groq(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_InflectionAi(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Langfuse(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Lmnt(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Make(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Openai(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Openrouter(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_PerplexityAi(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Playht(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_RimeAi(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Runpod(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_S3(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_S3Compatible(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Supabase(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_SmallestAi(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Tavus(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_TogetherAi(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Twilio(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Vonage(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Webhook(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_CustomCredential(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Xai(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Microsoft(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Neuphonic(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Hume(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Mistral(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Speechmatics(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Soniox(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_GoogleCalendarOauth2Client(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_GoogleCalendarOauth2Authorization(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_GoogleSheetsOauth2Authorization(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_SlackOauth2Authorization(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_GhlOauth2Authorization(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Inworld(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Minimax(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Wellsaid(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_Email(UncheckedBaseModel):
...
class AssistantDraftCredentialsItem_SlackWebhook(UncheckedBaseModel):
...
AssistantDraftCredentialsItem = typing_extensions.Annotated[
    typing.Union[
