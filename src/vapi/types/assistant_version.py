...
from .assistant_version_credentials_item import AssistantVersionCredentialsItem
...
from .assistant_version_model import AssistantVersionModel
from .assistant_version_server_messages_item import AssistantVersionServerMessagesItem
from .assistant_version_transcriber import AssistantVersionTranscriber
from .assistant_version_voice import AssistantVersionVoice
...
class AssistantVersion(UncheckedBaseModel):
    transcriber: typing.Optional[AssistantVersionTranscriber] = pydantic.Field(default=None)
    """
    These are the options for the assistant's transcriber.
    """

    model: typing.Optional[AssistantVersionModel] = pydantic.Field(default=None)
    """
    These are the options for the assistant's LLM.
    """

    voice: typing.Optional[AssistantVersionVoice] = pydantic.Field(default=None)
    """
    ...
    first_message_mode: typing_extensions.Annotated[
        typing.Optional[AssistantVersionFirstMessageMode],
    ...
    voicemail_detection: typing_extensions.Annotated[
        typing.Optional[AssistantVersionVoicemailDetection],
    ...
    client_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[AssistantVersionClientMessagesItem]],
    ...
    server_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[AssistantVersionServerMessagesItem]],
    ...
    background_sound: typing_extensions.Annotated[
        typing.Optional[AssistantVersionBackgroundSound],
    ...
    credentials: typing.Optional[typing.List[AssistantVersionCredentialsItem]] = pydantic.Field(default=None)
    """
    These are dynamic credentials that will be used for the assistant calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
    """

    hooks: typing.Optional[typing.List[AssistantVersionHooksItem]] = pydantic.Field(default=None)
    """
    ...
    restored_from_version: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="restoredFromVersion"),
        pydantic.Field(
            alias="restoredFromVersion",
            description="The version this version was restored from. Null when it was not restored.",
        ),
    ] = None
...
update_forward_refs(AssistantVersion)
