...
class CreateToolDraftDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateToolDraftDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateToolDraftDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateToolDraftDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateToolDraftDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
