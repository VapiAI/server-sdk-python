...
class CreateAssistantDraftDtoCredentialsItem_11Labs(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Anthropic(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_AnthropicBedrock(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Anyscale(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_AssemblyAi(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_AzureOpenai(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Azure(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_ByoSipTrunk(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Cartesia(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Cerebras(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Cloudflare(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_CustomLlm(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Deepgram(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Deepinfra(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_DeepSeek(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Gcp(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Gladia(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Gohighlevel(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Google(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Groq(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_InflectionAi(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Langfuse(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Lmnt(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Make(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Openai(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Openrouter(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_PerplexityAi(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Playht(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_RimeAi(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Runpod(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_S3(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_S3Compatible(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Supabase(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_SmallestAi(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Tavus(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_TogetherAi(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Twilio(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Vonage(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Webhook(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_CustomCredential(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Xai(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Microsoft(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Neuphonic(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Hume(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Mistral(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Speechmatics(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Soniox(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_GoogleCalendarOauth2Client(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_GoogleCalendarOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_GoogleSheetsOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_SlackOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_GhlOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Inworld(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Minimax(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Wellsaid(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_Email(UncheckedBaseModel):
...
class CreateAssistantDraftDtoCredentialsItem_SlackWebhook(UncheckedBaseModel):
...
CreateAssistantDraftDtoCredentialsItem = typing_extensions.Annotated[
    typing.Union[
