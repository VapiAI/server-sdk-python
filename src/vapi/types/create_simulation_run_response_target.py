...
class CreateSimulationRunResponseTarget_Assistant(UncheckedBaseModel):
    """
...
class CreateSimulationRunResponseTarget_Squad(UncheckedBaseModel):
    """
    Target to test against
    """
...
CreateSimulationRunResponseTarget = typing_extensions.Annotated[
    typing.Union[CreateSimulationRunResponseTarget_Assistant, CreateSimulationRunResponseTarget_Squad],
