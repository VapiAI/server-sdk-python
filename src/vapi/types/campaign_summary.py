...
class CampaignSummary(UncheckedBaseModel):
    status: CampaignSummaryStatus = pydantic.Field()
    """
    This is the status of the campaign.
    """

    ended_reason: typing_extensions.Annotated[
        typing.Optional[CampaignSummaryEndedReason],
    ...
    server_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[CampaignSummaryServerMessagesItem]],
    ...
    contact_counters: typing_extensions.Annotated[
        typing.Optional[CampaignContactCounters],
        FieldMetadata(alias="contactCounters"),
        pydantic.Field(
            alias="contactCounters",
            description="These are the per-status contact counts for this campaign. Sum them for the\ncampaign's total audience; `pending` plus `dispatched` is what is left to\ncomplete.",
        ),
    ] = None
    call_metrics: typing_extensions.Annotated[
        typing.Optional[CampaignCallMetrics],
        FieldMetadata(alias="callMetrics"),
        pydantic.Field(
            alias="callMetrics",
            description="These are the call-level outcomes for this campaign — how many contacts\nwere actually dialed, and how many of those a human picked up.",
        ),
    ] = None
