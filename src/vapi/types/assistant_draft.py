...
from .assistant_draft_credentials_item import AssistantDraftCredentialsItem
...
from .assistant_draft_model import AssistantDraftModel
from .assistant_draft_server_messages_item import AssistantDraftServerMessagesItem
from .assistant_draft_transcriber import AssistantDraftTranscriber
from .assistant_draft_voice import AssistantDraftVoice
...
class AssistantDraft(UncheckedBaseModel):
    transcriber: typing.Optional[AssistantDraftTranscriber] = pydantic.Field(default=None)
    """
    These are the options for the assistant's transcriber.
    """

    model: typing.Optional[AssistantDraftModel] = pydantic.Field(default=None)
    """
    These are the options for the assistant's LLM.
    """

    voice: typing.Optional[AssistantDraftVoice] = pydantic.Field(default=None)
    """
    ...
    first_message_mode: typing_extensions.Annotated[
        typing.Optional[AssistantDraftFirstMessageMode],
    ...
    voicemail_detection: typing_extensions.Annotated[
        typing.Optional[AssistantDraftVoicemailDetection],
    ...
    client_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[AssistantDraftClientMessagesItem]],
    ...
    server_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[AssistantDraftServerMessagesItem]],
    ...
    background_sound: typing_extensions.Annotated[
        typing.Optional[AssistantDraftBackgroundSound],
    ...
    credentials: typing.Optional[typing.List[AssistantDraftCredentialsItem]] = pydantic.Field(default=None)
    """
    These are dynamic credentials that will be used for the assistant calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
    """

    hooks: typing.Optional[typing.List[AssistantDraftHooksItem]] = pydantic.Field(default=None)
    """
    ...
    base_version: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="baseVersion", description="Server-resolved baseVersion (always set after POST)."),
    ]
    ...
    org_id: typing_extensions.Annotated[
        str, FieldMetadata(alias="orgId"), pydantic.Field(alias="orgId", description="Org this draft belongs to.")
    ]
...
update_forward_refs(AssistantDraft)
