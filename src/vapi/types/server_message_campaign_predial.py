...
from .server_message_campaign_predial_phone_number import ServerMessageCampaignPredialPhoneNumber
from .server_message_campaign_predial_type import ServerMessageCampaignPredialType


class ServerMessageCampaignPredial(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageCampaignPredialPhoneNumber],
    ...
    type: ServerMessageCampaignPredialType = pydantic.Field()
    """
    ...
    campaign_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="campaignId", description="This is the ID of the campaign the contact belongs to."),
    ]
    contact: CampaignContact = pydantic.Field()
    """
