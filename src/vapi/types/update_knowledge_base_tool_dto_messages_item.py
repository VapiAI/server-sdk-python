...
class UpdateKnowledgeBaseToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateKnowledgeBaseToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateKnowledgeBaseToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateKnowledgeBaseToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateKnowledgeBaseToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
