...
class SimulationRunListItemTarget_Assistant(UncheckedBaseModel):
    """
...
class SimulationRunListItemTarget_Squad(UncheckedBaseModel):
    """
    Target to test against
    """
...
SimulationRunListItemTarget = typing_extensions.Annotated[
    typing.Union[SimulationRunListItemTarget_Assistant, SimulationRunListItemTarget_Squad],
