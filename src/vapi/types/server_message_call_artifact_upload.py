...
from .server_message_call_artifact_upload_phone_number import ServerMessageCallArtifactUploadPhoneNumber
from .server_message_call_artifact_upload_type import ServerMessageCallArtifactUploadType


class ServerMessageCallArtifactUpload(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageCallArtifactUploadPhoneNumber],
    ...
    type: ServerMessageCallArtifactUploadType = pydantic.Field()
    """
    ...
    artifacts: typing.List[CallArtifactUploadItem] = pydantic.Field()
    """
