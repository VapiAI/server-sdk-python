...
from .create_assistant_draft_dto_credentials_item import CreateAssistantDraftDtoCredentialsItem
...
from .create_assistant_draft_dto_model import CreateAssistantDraftDtoModel
from .create_assistant_draft_dto_server_messages_item import CreateAssistantDraftDtoServerMessagesItem
from .create_assistant_draft_dto_transcriber import CreateAssistantDraftDtoTranscriber
from .create_assistant_draft_dto_voice import CreateAssistantDraftDtoVoice
...
class CreateAssistantDraftDto(UncheckedBaseModel):
    transcriber: typing.Optional[CreateAssistantDraftDtoTranscriber] = pydantic.Field(default=None)
    """
    These are the options for the assistant's transcriber.
    """

    model: typing.Optional[CreateAssistantDraftDtoModel] = pydantic.Field(default=None)
    """
    These are the options for the assistant's LLM.
    """

    voice: typing.Optional[CreateAssistantDraftDtoVoice] = pydantic.Field(default=None)
    """
    ...
    first_message_mode: typing_extensions.Annotated[
        typing.Optional[CreateAssistantDraftDtoFirstMessageMode],
    ...
    voicemail_detection: typing_extensions.Annotated[
        typing.Optional[CreateAssistantDraftDtoVoicemailDetection],
    ...
    client_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateAssistantDraftDtoClientMessagesItem]],
    ...
    server_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateAssistantDraftDtoServerMessagesItem]],
    ...
    background_sound: typing_extensions.Annotated[
        typing.Optional[CreateAssistantDraftDtoBackgroundSound],
    ...
    credentials: typing.Optional[typing.List[CreateAssistantDraftDtoCredentialsItem]] = pydantic.Field(default=None)
    """
    These are dynamic credentials that will be used for the assistant calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
    """

    hooks: typing.Optional[typing.List[CreateAssistantDraftDtoHooksItem]] = pydantic.Field(default=None)
    """
...
update_forward_refs(CreateAssistantDraftDto)
