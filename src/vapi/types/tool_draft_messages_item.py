...
class ToolDraftMessagesItem_RequestStart(UncheckedBaseModel):
...
class ToolDraftMessagesItem_RequestComplete(UncheckedBaseModel):
...
class ToolDraftMessagesItem_RequestFailed(UncheckedBaseModel):
...
class ToolDraftMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
ToolDraftMessagesItem = typing_extensions.Annotated[
    typing.Union[
