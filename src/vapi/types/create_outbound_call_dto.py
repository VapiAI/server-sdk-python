...
from .create_outbound_call_dto_transport import CreateOutboundCallDtoTransport
...
class CreateOutboundCallDto(UncheckedBaseModel):
    ...
    squad_version: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="squadVersion",
            description="This is the squad version to use for this call. Supported only with\ndirect `squadId`. Omit to follow the latest version.",
        ),
    ] = None
    transport: typing.Optional[CreateOutboundCallDtoTransport] = pydantic.Field(default=None)
    """
