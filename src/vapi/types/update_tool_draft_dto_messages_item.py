...
class UpdateToolDraftDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateToolDraftDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateToolDraftDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateToolDraftDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateToolDraftDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
